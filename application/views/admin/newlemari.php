			...
			<div class="large-12 columns">
				<div class="panel">
					<div class="row">
						...
						<div  class="large-12 columns">
							<strong><i class="icono-market" style='color:#296AD4;'></i>&nbsp;&nbsp;Lemari Baru</strong><hr>
						</div>
						...
						<div class="large-12 columns">
						  <div class="row collapse">
							...
							<div class="small-12 columns">
							  <input type="text" placeholder="" name="kodelemari" />
							</div>
						  </div>
						</div>
						...
						<div class="large-12 columns">
						  <div class="row collapse">
							...
							<div class="small-12 columns">
							  <textarea name="keterangan" placeholder="Keterangan lemari dapat berisi, penjelasan perihal ciri-ciri fisik lemari, misalnya yang berkaitan dengan merk, warna, lokasi, dsb."></textarea>
							</div>
						  </div>
						</div>
						...
						<div class="small-12 columns">
						  <a href="" data-role="newlemari" class="button postfix">Simpan Data Lemari Baru</a>
						</div>
