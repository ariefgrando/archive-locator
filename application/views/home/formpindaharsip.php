			...
			<div class="large-12 columns">
				<div class="panel">
					<div class="row">
						...
						<div  class="large-12 columns">
							<strong><i class="icono-paperClip" style='color:#296AD4;'></i>&nbsp;&nbsp;Pemindahan Arsip</strong><hr>
						</div>

						<?php echo form_open('user/proses/submitpindaharsip'); ?>
						...
						<div class="large-12 columns">
						  <div class="row collapse">
							...
							<div class="small-12 columns">
							  ...
							  <input type="text" value="<?php echo $query[0]->no_surat;?>"  name='nosurat' id='nosurat' />
							</div>
						  </div>
						</div>
						...
						<div class="large-12 columns">
						  <div class="row collapse">
							...
							<div class="small-12 columns">
							  <input type="text" value="<?php echo $query[0]->tgl_surat;?>" name='tanggalsurat' id='tanggalsurat'/>
							</div>
						  </div>
						</div>
						...
						<div class="large-12 columns">
						  <div class="row collapse">
							...
							<div class="small-12 columns">
							  <input type="text" value="<?php echo $query[0]->perihal_surat;?>"  name='perihalsurat' id='perihalsurat'/>
							</div>
						  </div>
						</div>
						...
						<div class="small-12 columns">
						  <a href="" data-role="update" class="button postfix">Update</a>
						</div>
